...
<head>    
    ...
    <!-- Fonts -->
        ...
        .icono{
          background: url("{{asset('img/logofa.jpg')}}");
          width:50px;
          height:50px;
          border-radius:50%;
    ...
    <div class="relative flex items-center justify-between h-16">
      ...
      <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="icono"></div>
          ...
          <img class="hidden lg:block h-8 w-auto" src="https://www.facico-uaemex.mx/" alt="">
        </div>
...
<div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a class="btn btn-sm" href="{{ route('computos.index2') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
