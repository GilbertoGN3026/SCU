...
<a class="btn btn-primary btn-sm float-right" href="{{route('computos.create')}}">Solicitar Equipo de Cómputo</a>

 
<h1>Listado de Solicitantes de Equipos de Cómputo, Impresiones y Escaneo.</h1>
