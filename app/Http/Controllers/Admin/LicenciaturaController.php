...
class LicenciaturaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.licenciaturas.index',$licenciatura)->with('success', 'La licenciatura se creó con exito.');
    ...
    public function update(Request $request, Licenciatura $licenciatura)
    {
        ...
        ->with('success', 'La licenciatura se actualizó con exito.');
    }
    ...
    public function destroy(Licenciatura $licenciatura)
    {
        ...
        ->with('success', 'La licenciatura se eliminó con exito.');;
    }
}