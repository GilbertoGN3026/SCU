...
class Insumo extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['user_nombre','numero_cuenta','aula','telefono','unidad_aprendizaje','profesor','licenciatura_id','tipo_id','numero_id','fecha_horaSol','fecha_horaEnt','conformidad'];
